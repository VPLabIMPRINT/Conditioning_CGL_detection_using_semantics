...
from dataset_multitask import TrainDataset
from mit_semseg.models.context_models3_matching_plus_contextual_features import ModelBuilder, SegmentationModule
...
def main(cfg, gpus):
    ...
    if cfg.MODEL.arch_decoder.endswith('deepsup'):
        segmentation_module = SegmentationModule(
            net_encoder, net_decoder, crit, crit1, cfg.TRAIN.deep_sup_scale)
    else:
        segmentation_module = SegmentationModule(
