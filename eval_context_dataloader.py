...
from dataset_original_context import ValDataset
from mit_semseg.models.models_context_dataloader import ModelBuilder, SegmentationModule
...
if __name__ == '__main__':
    ...
    for i in range(51):
        ...
        cfg.MODEL.weights_encoder = os.path.join(
            cfg.DIR, 'encoder_epoch_{}.pth'.format(i+1))
        cfg.MODEL.weights_decoder = os.path.join(
            cfg.DIR, 'decoder_epoch_{}.pth'.format(i+1))
