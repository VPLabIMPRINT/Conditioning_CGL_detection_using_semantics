    ...
    def forward(self, feed_dict, feed_dict_seg, *, segSize=None):
        ...
        if segSize is None:
            ...
            if self.deep_sup_scale is not None: # use deep supervision technique
                mask1 = feed_dict['seg_label_ori'][1:2,:,:]
                mask1[mask1 == -1] = 0
                mask2 = feed_dict['seg_label_ori'][0:1,:,:]
                mask2[mask2 == -1] = 0
                mask = mask1 * mask2
                if torch.sum(mask) == 0:
                    anti_mask = 1 - mask1
                    feed_dict['img_data'][0,:,:,:] = feed_dict['img_data'][0,:,:,:] * anti_mask + feed_dict['img_data'][1,:,:,:] * mask1    
                ...
                (pred1, pred_deepsup1) = self.decoder1(en_out1)
            else:
