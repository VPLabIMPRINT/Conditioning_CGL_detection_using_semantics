...
__all__ = ['hrnetv2', 'hrnetv2context']
...
class HighResolutionModule(nn.Module):
    ...
    def _make_one_branch(self, branch_index, block, num_blocks, num_channels,
        ...
        for i in range(1, num_blocks[branch_index]):
            ...
            # layers.append(ContextLayer(self.num_inchannels[branch_index],num_channels[branch_index], 5, 1, 2))
...
class HRNetV2Context(nn.Module):
    def __init__(self, n_class, **kwargs):
        super(HRNetV2Context, self).__init__()
        extra = {
        ...
        # self.context_layer1_2 = ContextLayer(48, 48, 5, 1, 2)
        # self.context_layer2_2 = ContextLayer(96, 96, 5, 1, 2)

        # self.context_layer1_4 = ContextLayer(48, 48, 5, 1, 2)
        # self.context_layer2_4 = ContextLayer(96, 96, 5, 1, 2)
        # self.context_layer3_4 = ContextLayer(192, 192, 5, 1, 2)
        # self.context_layer4_4 = ContextLayer(384, 384, 5, 1, 2)
    ...
    def _make_stage(self, layer_config, num_inchannels,
        ...
        for i in range(num_modules):
            ...
            # modules.append(ContextLayer(num_inchannels, num_channels, 5, 1, 2))
    ...
    def forward(self, x, return_feature_maps=False):
        ...
        # y_list[0] = self.context_layer1_2(y_list[0])
        # y_list[1] = self.context_layer2_2(y_list[1]) 
        ...
        # x[0] = self.context_layer1_4(x[0])
        # x[1] = self.context_layer2_4(x[1])
        # x[2] = self.context_layer3_4(x[2])
        # x[3] = self.context_layer4_4(x[3])
...
def hrnetv2context(pretrained=False, **kwargs):
    model = HRNetV2Context(n_class=1000, **kwargs)
    if pretrained:
        model.load_state_dict(load_url(model_urls['hrnetv2']), strict=False)
