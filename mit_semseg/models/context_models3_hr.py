...
class SegmentationModule(SegmentationModuleBase):
    def __init__(self, net_enc, net_enc1, net_dec, crit, deep_sup_scale=None):
    ...
    def forward(self, feed_dict, *, segSize=None):
        ...
        # inference
            ...
            pred = self.decoder(en_out, segSize=segSize)
            return pred
...
class ModelBuilder:
    ...
    def build_encoder(arch='resnet50dilated', fc_dim=512, weights='', weights1=''):
        ...
        if arch == 'mobilenetv2dilated':
            ...
            net_encoder = hrnet.__dict__['hrnetv2context'](pretrained=pretrained)
            net_encoder1 = hrnet.__dict__['hrnetv2'](pretrained=pretrained)
        else:
