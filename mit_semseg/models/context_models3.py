...
class ModelBuilder:
    ...
    def build_encoder(arch='resnet50dilated', fc_dim=512, weights='', weights1=''):
        ...
        if arch == 'mobilenetv2dilated':
            ...
            net_encoder = MobileNetV2DilatedContext(orig_mobilenet, dilate_scale=8)
...
class MobileNetV2Dilated(nn.Module):
    def __init__(self, orig_net, dilate_scale=8):
        ...
        self.add_layer = ContextLayer(320, 320, 5, 1, 2)
...
class MobileNetV2DilatedContext(nn.Module):
    def __init__(self, orig_net, dilate_scale=8):
        super(MobileNetV2DilatedContext, self).__init__()
        from functools import partial
