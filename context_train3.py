...
def train(segmentation_module, iterator, optimizers, history, epoch, cfg):
    ...
    for i in range(cfg.TRAIN.epoch_iters):
        ...
        # Backward
        loss.backward()
        # print(segmentation_module.encoder.features[19].context_layer.weight)
        
        # segmentation_module.encoder.features[11].context_layer.weight.grad[:,:,1:4,1:4] = 0
        # segmentation_module.encoder.features[19].context_layer.weight.grad[:,:,1:4,1:4] = 0
